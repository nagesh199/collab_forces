...
const Gainers = () => {
  ...
  return (
    ...
    <div style={{display: 'grid',gridTemplateColumns:"50% 50%",justifyContent: 'space-around'}}>
     ...
     <p style={{marginLeft:'72%',color:'#0456B9',paddingBottom:'3px',paddingLeft:"4px",width:"70px",height:'20px',borderRadius:"5px",cursor:'pointer', fontWeight:"bold"}}>See More</p>
    </div>
